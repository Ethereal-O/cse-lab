...
{
    // Lab3: Your code here
    m << args.term << args.leader_id << args.prev_log_index << args.prev_log_term << args.entries << args.leader_commit;
    return m;
}
...
{
    // Lab3: Your code here
    u >> args.term >> args.leader_id >> args.prev_log_index >> args.prev_log_term >> args.entries >> args.leader_commit;
    return u;
}
